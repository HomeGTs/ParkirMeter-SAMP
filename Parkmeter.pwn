...
#define			 	MAX_METERS 					100 	// Maximum parkir meter
#define 			CASH_PER_MINUTES        	10    	// ini untuk ganti harga parkir permenit
...
{
	printf("  Parking Meter By HomeGT");
...
CMD:createparkmeter(playerid, params[])
{
	...
	{
	    SendClientMessage(playerid, -1, "* You need to Rcon login to use this command.");
	}
	return 1;
}
...
stock LoadParkMeters()
{
	...
	printf("* %d parkir meter yang terload", idx);
	return 1;
}
